...
public class ApprovalOutboxHelper {
    ...
    public void save(OrderApprovalOutboxMessage orderApprovalOutboxMessage) {
        ...
        if(response == null) {
            log.error("Couldn't save OrderApprovalOutboxMessage with outbox id: {}",
                    orderApprovalOutboxMessage.getId());
            throw new OrderDomainException("Couldn't save OrderApprovalOutboxMessage with outbox id: " +
                    orderApprovalOutboxMessage.getId());
        }
