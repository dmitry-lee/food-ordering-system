...
import com.food.ordering.system.restaurant.service.domain.exceptions.RestaurantApplicationServiceException;
import com.food.ordering.system.restaurant.service.domain.exceptions.RestaurantNotFoundException;
    ...
    public void receive(@Payload List<RestaurantApprovalRequestAvroModel> messages,
        ...
        messages.forEach(restaurantApprovalRequestAvroModel -> {
            try {
                ...
                PSQLException sqlException = (PSQLException) e.getRootCause();
