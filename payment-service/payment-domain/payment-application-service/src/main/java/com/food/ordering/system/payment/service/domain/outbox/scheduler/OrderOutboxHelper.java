...
public class OrderOutboxHelper {
    ...
    private String createPayload(OrderEventPayload orderEventPayload) {
        try {
            ...
            log.error("Couldn't create OrderOutboxMessage json");
            throw new PaymentDomainException("Couldn't create OrderOutboxMessage json", e);
        }
    }
    ...
    private void save(OrderOutboxMessage outboxMessage) {
        ...
        if (response == null) {
            log.error("Couldn't save OrderOutboxMessage");
            throw new PaymentDomainException("Couldn't save OrderOutboxMessage");
        }
        log.info("OrderOutboxMessage is saved with id: {}", outboxMessage.getId());
    }
}
